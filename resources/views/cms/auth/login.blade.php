...
<html lang="en" class="light-style layout-wide customizer-hide" dir="ltr" data-theme="theme-default"
    data-assets-path="{{ asset('/cms-assets/') }}" data-template="horizontal-menu-template-no-customizer">
...
<head>
    ...
    <!-- Vendor -->
    <link rel="stylesheet" href="{{ asset('/cms-assets/vendor/libs/@form-validation/form-validation.css') }}" />
...
<body>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{ route('login') }}" method="POST">
                            ...
                            <div class="mb-3form-password-toggle">
    ...
    <!-- Vendors JS -->
    <script src="{{ asset('/cms-assets/vendor/libs/@form-validation/popular.js') }}"></script>
    <script src="{{ asset('/cms-assets/vendor/libs/@form-validation/bootstrap5.js') }}"></script>
    <script src="{{ asset('/cms-assets/vendor/libs/@form-validation/auto-focus.js') }}"></script>
